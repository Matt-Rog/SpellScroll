            ...
            >
              <View style={{ marginBottom: 20 }}>
                ...
                {value.known.length == 0 ? (
                  <Text style={[STYLES.ContentBody, { marginBottom: 20 }]}>
                    No spells found
                  </Text>
                ) : (
                  <SpellList
  ...
  return (
    <SafeAreaView style={STYLES.Background}>
          ...
          <View style={{ flexDirection: "column", justifyContent: "center" }}>
            ...
            <FlatList
              ...
              renderItem={({ item }) => {
                return (
                  <View
                    style={[STYLES.Tags, { marginTop: 10, marginRight: 8 }]}
                  >
            ...
            <Text
              style={[
                STYLES.ContentBody,
                { marginTop: char.notes.length > 0 ? 10 : 0 },
              ]}
            >
              {char.notes}
            </Text>
      ...
      {Object.keys(data).length > 1 ? (
        <SlidingTab data={data} color={char.color}></SlidingTab>
      ) : (
        <View>
          <View style={{ alignSelf: "center" }}>
            <Text style={[STYLES.Header4, { paddingVertical: 10 }]}>
              {char.classes[0]}
            </Text>
            <View
              style={{ height: 4, width: "auto", backgroundColor: char.color }}
            ></View>
          </View>
          <ScrollView
            style={[
          ...
          >
            <View style={{ marginBottom: 20 }}>
              <Text style={STYLES.Header4}>KNOWN</Text>
              {Object.values(Object.values(spells)[0])[0] == 0 ? (
                <Text style={[STYLES.ContentBody, { marginBottom: 20 }]}>
                  No spells found
                </Text>
              ) : (
            ...
            <Text style={STYLES.Header4}>PREPARED</Text>
            {Object.values(Object.values(spells)[0])[1] == 0 ? (
              <Text style={[STYLES.ContentBody, { marginBottom: 20 }]}>
                No spells found
              </Text>
            ) : (
