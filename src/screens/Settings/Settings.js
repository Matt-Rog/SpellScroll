      ...
      <View style={STYLES.Container}>
        ...
        <View style={{ paddingTop: 40 }}>
          ...
          <Text
            style={[
              STYLES.Header3,
              { color: COLORS.secondary_content, marginTop: 5 },
            ]}
          >
            Theme
          </Text>
            ...
            renderItem={({ item }) => (
              <Pressable
                ...
                style={{
                  ...
                  borderRadius: 8,
                  backgroundColor:
                    item == selected ? COLORS.primary_accent : COLORS.back,
                  marginRight: 10,
                  marginVertical: 5,
                }}
              >
          ...
          ></FlatList>
          <Text style={[STYLES.Note, { color: COLORS.secondary_accent }]}>
            {changed ? "App restart required" : null}
          </Text>
        </View>
        ...
        <View style={{ paddingVertical: 15 }}>
          ...
          >
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              <FontAwesome
                ...
                color={COLORS.primary_content}
              />
              <Text style={[STYLES.Header4, { padding: 10 }]}>
          ...
          <Text style={[STYLES.Note, { color: COLORS.secondary_accent }]}>
            {deleted ? "App restart required" : "Cannot be undone"}
          </Text>
        </View>
        ...
        <View style={{ paddingVertical: 15 }}>
          ...
          >
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              ...
              <Text
                style={[
                  STYLES.Header4,
                  { color: COLORS.primary_content, padding: 10 },
                ]}
              >
                Report a bug
              </Text>
          ...
          <Text style={[STYLES.Note, { color: COLORS.secondary_accent }]}>
            {reported ? "Reporting not available" : null}
          </Text>
        </View>
      </View>
    </SafeAreaView>
