      ...
      <View style={[STYLES.Modal, { width: WIDTH - 20, height: HEIGHT / 1.7 }]}>
        ...
        >
          ...
          <View style={{ flexDirection: "row" }}>
            <Pressable
              onPress={() =>
                selected.length > 0 ? setSelected([]) : setSelected(options)
              }
              style={[
            ...
            >
              ...
              />
              <Text style={[STYLES.Header3, { marginLeft: 10 }]}>All</Text>
            </Pressable>
          </View>
        </View>
        <FlatList
        ...
        >
          ...
          >
            <Text style={[styles.applyTXT, { color: COLORS.primary_content }]}>
              Apply
            </Text>
          </Pressable>
          <Pressable
          ...
          >
            <Text
              style={[styles.cancelTXT, { color: COLORS.secondary_content }]}
            >
              Cancel
            </Text>
          </Pressable>
